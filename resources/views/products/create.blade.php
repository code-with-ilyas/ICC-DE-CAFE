...
<div class="container mt-3">
    <div class="card shadow-sm p-3">
        <div class="d-flex justify-content-between align-items-center mb-2">
            <h5 class="mb-0 text-white">Add New Product</h5>
            <a href="{{ route('products.index') }}" class="btn btn-success btn-sm">
                <i class="fas fa-arrow-left"></i>Show All Products
            </a>
        </div>



        {{-- Debugging: Check if $categories is defined --}}
        @if(!isset($categories))
        <div class="alert alert-danger">
            The $categories variable is not defined.
        </div>
        @else
            ...
            <div class="row gx-2 gy-2">
                ...
                <div class="col-md-6">
                    ...
                    <select name="category_id" id="category_id" class="form-select form-select-sm @error('category_id') is-invalid @enderror">
                        ...
                        @error('category_id')
                        <div class="invalid-feedback">{{-- Custom message or leave empty --}}</div>
                        @enderror
                        @endforeach
                    </select>
                    @error('category_id')
                ...
                <div class="col-md-6">
                    ...
                    <input type="number" name="price" id="price" class="form-control form-control-sm @error('price') is-invalid @enderror" step="0.01" value="{{ old('price') }}">
                    @error('price')
                    <div class="invalid-feedback d-block">{{ $message }}</div>
                    @enderror
                </div>
                ...
                <div class="col-md-6 d-flex align-items-center">
                    <input type="checkbox" name="is_available" id="is_available" value="1" class="form-check-input me-2" {{ old('is_available', 0) ? 'checked' : '' }}>
